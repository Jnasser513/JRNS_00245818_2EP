...
namespace Preparcial
{
    public partial class FrmLogin : Form
    {
        ...
        private void PoblarControlers()
        {
            ...
            //Correccion: en la clase usuario esta declarada la variable como "contrasena" y no "contrasenia"
        ...
        private void BttnUpdatePassword_Click(object sender, EventArgs e)
        {
            ...
            //correcion: reemplazar .show() por .showDialog() para que no pueda acceder al login,
            //sin antes haber cerrado el FrmPassword
            frmPassword.ShowDialog();
            //Correcion: invocar metodo PoblarControlers() para actualizar el valor de la nueva contrasenia
            PoblarControlers();
        }
    }
}
